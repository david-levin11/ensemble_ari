...
proj_string = """+proj=merc +a=6371200 +b=6371200 +lat_ts=20 +lon_0=-160 +units=m +no_defs"""

# Define the geotransform values
#geotransform = [-519274.6447822295, 2500, 0, 2915561.4041805766, 0, -2500]
...
nrows = 561  # number of rows
ncols = 625  # number of columns
...
with xr.open_dataset(os.path.join(ensemble_dir, ds)) as orig_grid:
    lats = orig_grid.latitude.values.reshape(561,625)
    lons = orig_grid.longitude.values.reshape(561,625)
