...
PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"latitude_of_origin\",25],
PARAMETER[\"central_meridian\",-95],PARAMETER[\"standard_parallel_1\",25],
PARAMETER[\"standard_parallel_2\",25],PARAMETER[\"false_easting\",0],
PARAMETER[\"false_northing\",0],UNIT[\"Metre\",1],AXIS[\"Easting\",EAST],
AXIS[\"Northing\",NORTH]]"""

# Define the geotransform values
#geotransform = [-3272421.4573371694, 2539.703, 0.0, 3790842.1060354356, 0.0, -2539.703]
# Create the SpatialReference object
srs = osr.SpatialReference()
srs.ImportFromWkt(proj_string)

# Define grid size (e.g., 100x100 grid)
nrows = 1597  # number of rows
ncols = 2345  # number of columns
...
top_lat = 53.05056309721963
top_lon = 221.62673184604006
...
pixel_size_x = 2539.703
pixel_size_y = -2539.703
...
print(f"Latitude shape is: {latitudes.shape}")
print(f"Longitude shape is: {longitudes.shape}")
...
# top_left_lon = lons[-1, 0]  # First longitude
